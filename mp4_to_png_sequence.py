...
def convert_videos_to_png_sequence(input_folder, output_folder, log_queue=None):
    """
    Converts all MP4 videos in the input folder into a PNG sequence in the output folder.
...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.master = master
        self.master.title("MP4 to PNG Sequence Converter")
        self.pack(fill="both", expand=True)

        self.input_folder = tk.StringVar(value="./mp4s_input")
        self.output_folder = tk.StringVar(value="./pngs_output")
